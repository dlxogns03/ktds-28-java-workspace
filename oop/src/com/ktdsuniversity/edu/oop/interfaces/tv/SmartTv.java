...
public class SmartTv implements TV{
	...
	public void IncreaseChannel() {
		...
		this.channalNumber++;
		if(this.channalNumber == TV.CHANNELS.length) {
			this.channalNumber = 0;
		}
		String channelName = TV.CHANNELS[this.channalNumber];
	...
	public void decreaseChannel() {
		...
		this.channalNumber--;
		if(this.channalNumber < 0) {
			this.channalNumber = TV.CHANNELS.length - 1;
		}
		String channelName = TV.CHANNELS[this.channalNumber];
		System.out.println("현재 보고 있는 채널은 " + channelName + "입니다.");
	...
	public void runApps() {
		...
		System.out.println("실행되는 APP : " + appName);
